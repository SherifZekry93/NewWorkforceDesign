...
class DemoBaseViewController: UIViewController, ChartViewDelegate {
    ...
    func setup(pieChartView chartView: PieChartView) {
        ...
        let centerText = NSMutableAttributedString(string: "Absenteeism")
        centerText.addAttributes([NSAttributedString.Key.font:UIFont.systemFont(ofSize: 25)], range: NSRange(location: 0, length: centerText.length))
